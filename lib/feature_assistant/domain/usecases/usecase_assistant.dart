...
class UseCaseAssistant {
  ...
  UseCaseAssistant({required this.createFreelyTalkRoom, required this.freelyTalkChat, required this.getAllFreelyTalkRooms, required this.createGrammarTalkRoom, required this.grammarTalkChat});
}